    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (spaceCopy > 0)
            {
                ...
                {
                    Console.WriteLine($"{Math.Abs(spaceCopy - space)} Cubic meters left.");
                    return;
                }
                int numberOfBoxesINT = int.Parse(numberOfBoxes);
                spaceCopy -= numberOfBoxesINT;
                if (space < 0)
                {
                ...
                Console.WriteLine($"No more free space! You need {Math.Abs(spaceCopy)} Cubic meters more.");
